...
description: "Gstack skill for plan-eng-review"
---
// turbo-all
...
```bash
C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/bin/gstack-review-log '{"skill":"plan-eng-review","timestamp":"TIMESTAMP","status":"STATUS","unresolved":N,"critical_gaps":N,"issues_found":N,"mode":"MODE","commit":"COMMIT"}'
```
