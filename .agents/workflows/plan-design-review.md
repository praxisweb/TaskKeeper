...
description: "Gstack skill for plan-design-review"
---
// turbo-all
...
**Log the result:**
```bash
C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/bin/gstack-review-log '{"skill":"design-outside-voices","timestamp":"'"$(date -u +%Y-%m-%dT%H:%M:%SZ)"'","status":"STATUS","source":"SOURCE","commit":"'"$(git rev-parse --short HEAD)"'"}'
```
...
```bash
C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/bin/gstack-review-log '{"skill":"plan-design-review","timestamp":"TIMESTAMP","status":"STATUS","initial_score":N,"overall_score":N,"unresolved":N,"decisions_made":N,"commit":"COMMIT"}'
```
