---
name: gstack-upgrade
description: "Gstack skill for gstack-upgrade"
---
// turbo-all
...
[ -z "$_AUTO" ] && _AUTO=$(C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/bin/gstack-config get auto_upgrade 2>/dev/null || true)
...
```bash
C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/bin/gstack-config set auto_upgrade true
```
...
**If "Never ask again":**
```bash
C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/bin/gstack-config set update_check false
```
Tell user: "Update checks disabled. Run `C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/bin/gstack-config set update_check true` to re-enable."
...
```bash
C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/bin/gstack-update-check --force 2>/dev/null || \
