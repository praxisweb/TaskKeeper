...
description: "Gstack skill for land-and-deploy"
---
// turbo-all
...
```bash
C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/bin/gstack-review-read 2>/dev/null
```
...
```bash
cat C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/review/checklist.md 2>/dev/null || echo "Checklist not found"
```
...
```bash
eval $(C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/bin/gstack-diff-scope $(gh pr view --json baseRefName -q .baseRefName 2>/dev/null || echo main) 2>/dev/null)
