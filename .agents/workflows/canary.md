---
name: canary
description: "Gstack skill for canary"
---
// turbo-all
...
```bash
eval "$(C:/Users/jason/Documents/Code/TaskKeeper/.agent/skills/gstack/gstack/bin/gstack-slug 2>/dev/null || echo "SLUG=unknown")"
